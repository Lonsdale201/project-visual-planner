...
export const nodeTypeRegistry: Record<NodeKind, NodeTypeDef> = {
  ...
  feature: {
    ...
    defaultStylePreset: 'cyclamen',
    inputHandles: 1,
    outputHandles: 1,
    fields: [
      { key: 'name', label: 'Name', type: 'string', placeholder: 'Form Builder, Client Upload...' },
      { key: 'tag', label: 'Tag', type: 'string', placeholder: 'UX, Backend, Auth, Payment...' },
      { key: 'description', label: 'Description', type: 'text', placeholder: 'What does this feature do and why?' },
      { key: 'priority', label: 'Priority', type: 'enum', options: ['must', 'should', 'could', 'wont'] },
      { key: 'complexity', label: 'Complexity', type: 'enum', options: ['trivial', 'small', 'medium', 'large', 'epic'] },
      { key: 'status', label: 'Status', type: 'enum', options: ['idea', 'planned', 'in-progress', 'testing', 'done'] },
      { key: 'userStory', label: 'User Story', type: 'text', placeholder: 'As a [role], I want [goal] so that [benefit]...' },
      { key: 'acceptanceCriteria', label: 'Acceptance Criteria', type: 'text', placeholder: 'When is this feature considered done?' },
    ],
    defaultData: {
      name: 'Form Builder',
      tag: 'UX',
      description: 'Users can create and submit custom forms with validation and file upload support.',
      priority: 'must',
      complexity: 'medium',
      status: 'planned',
      userStory: 'As a project manager, I want to create custom intake forms so that clients can submit structured requests.',
      acceptanceCriteria: '- Form renders with all field types\n- Validation errors shown inline\n- Submission triggers notification\n- Data saved to database',
    },
  },
